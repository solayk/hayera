...
function cartListing(loc, data, price) {
  $(loc).append(
    ...
    + '<td>'
    + '<button type="button" class="btn btn-primary btn-xs" id="countDown" style="background-color: #125288;">'
    + '<span class="glyphicon glyphicon-minus"></span>' + '</button>'
    + '<span class="cartEachQty">' + data[i].each_qty + '</span>'
    + '<button type="button" class="btn btn-primary btn-xs" id="countUp" style="background-color: #125288;">'
